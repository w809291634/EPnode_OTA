...
#define HAL_PUSH1_SEL     P1SEL
#define HAL_PUSH1_DIR     P1DIR
...
#define HAL_PUSH2_SEL     P1SEL
#define HAL_PUSH2_DIR     P1DIR
#define PUSH2_BV          BV(3)
#define PUSH2_SBIT        P1_3

#else /* GreenHouse */

#define HAL_PUSH2_SEL     P2SEL
#define HAL_PUSH2_DIR     P2DIR
