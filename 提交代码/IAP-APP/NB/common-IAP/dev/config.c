...
//  return 0;
  ...
  nb_config_t temp_param;
  STMFLASH_Read(PARAMETER_ADDRESS, (u16*)&temp_param, (sizeof(nb_config_t)+1)>>1);
  if (temp_param.flag != 0xa5a5a5a5) {  //未初始化
    nbConfig.boot_mode = BOOT_APP;
    nbConfig.app_en = APP_OK;
    nbConfig.flag = 0xa5a5a5a5;
    return 0;
  } else {
    nbConfig = temp_param;
    return 1;
...
//  }
  nbConfig.flag = 0xa5a5a5a5;
  STMFLASH_Write(PARAMETER_ADDRESS, (u16*)&nbConfig, (sizeof(nbConfig)+1)>>1);
}